    ...
    public static class LocalDateTimeAssertionsSpecs
    {
        ...
        public class BeInCalendar
        {
            ...
            public void When_asserting_a_null_local_date_time_has_a_calendar_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to be in calendar {calendar}, but found <null>.");
            }
        }
        ...
        public class NotBeInCalendar
        {
            ...
            public void When_asserting_a_null_local_date_time_has_a_calendar_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to be in calendar {calendar}, but found <null>.");
            }
        }
        ...
        public class HaveDate
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_date_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have date {date}, but found <null>.");
            }
        }
        ...
        public class NotHaveDate
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_date_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have date {date}, but found <null>.");
            }
        }
        ...
        public class HaveTimeOfDay
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_time_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have time of day {time}, but found <null>.");
            }
        }
        ...
        public class NotHaveTimeOfDay
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_time_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have time of day {time}, but found <null>.");
            }
        }
        ...
        public class HaveClockHourOfHalfDay
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have clock hour of the half-day of {time}, but found <null>.");
            }
        }
        ...
        public class NotHaveClockHourOfHalfDay
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_clock_hour_of_half_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have clock hour of the half-day of {time}, but found <null>.");
            }
        }
        ...
        public class HaveDay
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have day {day}, but found <null>.");
            }
        }
        ...
        public class NotHaveDay
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have day {day}, but found <null>.");
            }
        }
        ...
        public class HaveDayOfWeek
        {
            ...
            public void When_asserting_a_null_local_date_has_the_specified_day_of_week_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found <null>.");
            }
        }
        ...
        public class NotHaveDayOfWeek
        {
            ...
            public void When_asserting_a_null_local_date_does_not_have_the_specified_day_of_week_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have day of week {dayOfWeek.AsFormatted()}, but found <null>.");
            }
        }
        ...
        public class HaveDayOfYear
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_day_of_year_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have day of year {dayOfYear}, but found <null>.");
            }
        }
        ...
        public class NotHaveDayOfYear
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_day_of_year_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have day of year {dayOfYear}, but found <null>.");
            }
        }
        ...
        public class HaveHour
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_hour_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have hour of day {hourOfDay}, but found <null>.");
            }
        }
        ...
        public class NotHaveHour
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_hour_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have hour of day {hourOfDay}, but found <null>.");
            }
        }
        ...
        public class HaveEra
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_era_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have era {era}, but found <null>.");
            }
        }
        ...
        public class NotHaveEra
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_era_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have era {era}, but found <null>.");
            }
        }
        ...
        public class HaveMillisecond
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_millisecond_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have millisecond {millisecondOfDay}, but found <null>.");
            }
        }
        ...
        public class NotHaveMillisecond
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_millisecond_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have millisecond {millisecondOfDay}, but found <null>.");
            }
        }
        ...
        public class HaveMinute
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_minute_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have minute {minuteOfDay}, but found <null>.");
            }
        }
        ...
        public class NotHaveMinute
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_minute_of_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have minute {minuteOfDay}, but found <null>.");
            }
        }
        ...
        public class HaveMonth
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_month_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have month {month}, but found <null>.");
            }
        }
        ...
        public class NotHaveMonth
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_month_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have month {month}, but found <null>.");
            }
        }
        ...
        {
            [Fact]
            public void When_a_local_date_time_has_the_specified_nanoseconds_within_the_day_it_succeeds()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());

                // Act
                Action act = () => localDateTime.Should().HaveNanosecondsWithinDay(localDateTime.NanosecondOfDay);
            ...
            [Fact]
            public void When_a_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());
                ...
                // Act
                Action act = () => localDateTime.Should().HaveNanosecondsWithinDay(nanosecondOfDay);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found {localDateTime.NanosecondOfDay.AsFormatted()}.");
            }

            [Fact]
            [SuppressMessage("ReSharper", "ExpressionIsAlwaysNull", Justification = "It is supposed to be null for the test.")]
            public void When_asserting_a_null_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                // Arrange
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found <null>.");
            }
        }
        ...
        {
            [Fact]
            public void When_a_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());

                // Act
                Action act = () => localDateTime.Should().NotHaveNanosecondsWithinDay(localDateTime.NanosecondOfDay);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {localDateTime.NanosecondOfDay.AsFormatted()} nanoseconds within the day.");
            }

            [Fact]
            public void When_a_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_succeeds()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());
                long nanosecondOfDay = localDateTime.PlusNanoseconds(1).NanosecondOfDay;
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveNanosecondsWithinDay(nanosecondOfDay);
            ...
            [Fact]
            [SuppressMessage("ReSharper", "ExpressionIsAlwaysNull", Justification = "It is supposed to be null for the test.")]
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                // Arrange
                long nanosecondOfDay = new Random().Next(1, 999_999_999);
                LocalDateTime? localDateTime = null;
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {nanosecondOfDay.AsFormatted()} nanoseconds within the day, but found <null>.");
            }
        }
        ...
        public class HaveNanosecondsWithinSecond
        {
            ...
            public void When_a_local_date_time_has_the_specified_nanoseconds_within_the_day_it_succeeds()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().HaveNanosecondsWithinSecond(localDateTime.NanosecondOfSecond);
            ...
            public void When_a_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().HaveNanosecondsWithinSecond(nanosecondOfSecond);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found {localDateTime.NanosecondOfSecond}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found <null>.");
            }
        }
        ...
        public class NotHaveNanosecondsWithinSecond
        {
            ...
            public void When_a_local_date_time_has_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveNanosecondsWithinSecond(localDateTime.NanosecondOfSecond);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {localDateTime.NanosecondOfSecond} nanoseconds within the second.");
            }
            ...
            public void When_a_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_succeeds()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveNanosecondsWithinSecond(nanosecondOfSecond);
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_nanoseconds_within_the_day_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {nanosecondOfSecond} nanoseconds within the second, but found <null>.");
            }
        }
        ...
        public class HaveSecond
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_second_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have second {second}, but found <null>.");
            }
        }
        ...
        public class NotHaveSecond
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_second_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have second {second}, but found <null>.");
            }
        }
        ...
        public class HaveYear
        {
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_year_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have year {year}, but found <null>.");
            }
        }
        ...
        public class NotHaveYear
        {
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_year_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have year {year}, but found <null>.");
            }
        }
        ...
        {
            [Fact]
            public void When_a_local_date_time_has_the_specified_ticks_within_the_day_it_succeeds()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());

                // Act
                Action act = () => localDateTime.Should().HaveTicksWithinDay(localDateTime.TickOfDay);
            ...
            [Fact]
            public void When_a_local_date_time_does_not_have_the_specified_ticks_within_the_day_it_fails()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());
                ...
                // Act
                Action act = () => localDateTime.Should().HaveTicksWithinDay(tickOfDay);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found {localDateTime.TickOfDay.AsFormatted()}.");
            }

            [Fact]
            [SuppressMessage("ReSharper", "ExpressionIsAlwaysNull", Justification = "It is supposed to be null for the test.")]
            public void When_asserting_a_null_local_date_time_has_the_specified_ticks_within_the_day_it_fails()
            {
                // Arrange
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found <null>.");
            }
        }
        ...
        {
            [Fact]
            public void When_a_local_date_time_has_the_specified_ticks_within_the_day_it_fails()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());

                // Act
                Action act = () => localDateTime.Should().NotHaveTicksWithinDay(localDateTime.TickOfDay);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {localDateTime.TickOfDay.AsFormatted()} ticks within the day.");
            }

            [Fact]
            public void When_a_local_date_time_does_not_have_the_specified_ticks_within_the_day_it_succeeds()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());
                long tickOfDay = localDateTime.PlusTicks(1).TickOfDay;
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveTicksWithinDay(tickOfDay);
            ...
            [Fact]
            [SuppressMessage("ReSharper", "ExpressionIsAlwaysNull", Justification = "It is supposed to be null for the test.")]
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_ticks_within_the_day_it_fails()
            {
                // Arrange
                long tickOfDay = new Random().Next(1, 999_999_999);
                LocalDateTime? localDateTime = null;
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {tickOfDay.AsFormatted()} ticks within the day, but found <null>.");
            }
        }
        ...
        public class HaveTicksWithinSecond
        {
            ...
            public void When_a_local_date_time_has_the_specified_tick_of_second_it_succeeds()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().HaveTicksWithinSecond(localDateTime.TickOfSecond);
            ...
            public void When_a_local_date_time_does_not_have_the_specified_tick_of_second_it_fails()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().HaveTicksWithinSecond(tickOfSecond);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {tickOfSecond} ticks within the second, but found {localDateTime.TickOfSecond}.");
            }
            ...
            public void When_asserting_a_null_local_date_time_has_the_specified_tick_of_second_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {tickOfSecond} ticks within the second, but found <null>.");
            }
        }
        ...
        public class NotHaveTicksWithinSecond
        {
            ...
            public void When_a_local_date_time_has_the_specified_tick_of_second_it_fails()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveTicksWithinSecond(localDateTime.TickOfSecond);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {localDateTime.TickOfSecond} ticks within the second.");
            }
            ...
            public void When_a_local_date_time_does_not_have_the_specified_tick_of_second_it_succeeds()
            {
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveTicksWithinSecond(tickOfSecond);
            ...
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_tick_of_second_it_fails()
            {
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {tickOfSecond} ticks within the second, but found <null>.");
            }
        }
        ...
        {
            [Fact]
            public void When_a_local_date_time_has_the_specified_as_the_year_within_the_era_it_succeeds()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());

                // Act
                Action act = () => localDateTime.Should().HaveYearWithinEra(localDateTime.YearOfEra);
            ...
            [Fact]
            public void When_a_local_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_fails()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());
                ...
                // Act
                Action act = () => localDateTime.Should().HaveYearWithinEra(yearOfEra);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {yearOfEra} as the year within the era, but found {localDateTime.YearOfEra}.");
            }

            [Fact]
            [SuppressMessage("ReSharper", "ExpressionIsAlwaysNull", Justification = "It is supposed to be null for the test.")]
            public void When_asserting_a_null_local_date_time_has_the_specified_as_the_year_within_the_era_it_fails()
            {
                // Arrange
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Expected {nameof(localDateTime)} to have {yearOfEra} as the year within the era, but found <null>.");
            }
        }
        ...
        {
            [Fact]
            public void When_a_local_date_time_has_the_specified_as_the_year_within_the_era_it_fails()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());

                // Act
                Action act = () => localDateTime.Should().NotHaveYearWithinEra(localDateTime.YearOfEra);

                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {localDateTime.YearOfEra} as the year within the era.");
            }

            [Fact]
            public void When_a_local_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_succeeds()
            {
                // Arrange
                LocalDateTime localDateTime = LocalDateTime.FromDateTime(DateTime.Now, RandomCalendarSystem());
                int yearOfEra = localDateTime.PlusYears(1).YearOfEra;
                ...
                // Act
                Action act = () => localDateTime.Should().NotHaveYearWithinEra(yearOfEra);
            ...
            [Fact]
            [SuppressMessage("ReSharper", "ExpressionIsAlwaysNull", Justification = "It is supposed to be null for the test.")]
            public void When_asserting_a_null_local_date_time_does_not_have_the_specified_as_the_year_within_the_era_it_fails()
            {
                // Arrange
                int yearOfEra = new Random().Next(1, 100);
                LocalDateTime? localDateTime = null;
                ...
                // Assert
                act.Should().Throw<XunitException>()
                    .WithMessage($"Did not expect {nameof(localDateTime)} to have {yearOfEra} as the year within the era, but found <null>.");
            }
        }
