# LocalTimeAssertions.HaveNanosecondsWithinDay method

Asserts that the current LocalTime has the specified nanoseconds within the day.

```csharp
public AndConstraint<LocalTimeAssertions> HaveNanosecondsWithinDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanoseconds within the day that the current LocalTime is expected to have. |
