# LocalTimeAssertions.HaveNanosecondOfDay method

Asserts that the current LocalTime has the specified nanosecond of day.

```csharp
public AndConstraint<LocalTimeAssertions> HaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current LocalTime is expected to have. |
