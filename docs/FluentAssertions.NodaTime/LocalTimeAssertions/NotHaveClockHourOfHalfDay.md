# LocalTimeAssertions.NotHaveClockHourOfHalfDay method

Asserts that the current LocalTime does not have the specified hour of the half-day.

```csharp
public AndConstraint<LocalTimeAssertions> NotHaveClockHourOfHalfDay(int clockHourOfHalfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| clockHourOfHalfDay | The hour of the half-day that the current LocalTime is not expected to have. |
