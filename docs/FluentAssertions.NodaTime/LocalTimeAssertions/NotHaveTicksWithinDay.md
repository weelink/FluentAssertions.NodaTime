# LocalTimeAssertions.NotHaveTicksWithinDay method

Asserts that the current LocalTime does not have the specified tick of day.

```csharp
public AndConstraint<LocalTimeAssertions> NotHaveTicksWithinDay(long tickOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfDay | The tick of day that the current LocalTime is not expected to have. |
