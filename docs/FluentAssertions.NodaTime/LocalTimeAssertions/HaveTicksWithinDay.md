# LocalTimeAssertions.HaveTicksWithinDay method

Asserts that the current LocalTime has the specified tick of day.
...
| --- | --- |
| tickOfDay | The tick of day that the current LocalTime is expected to have. |
