# LocalTimeAssertions.NotHaveNanosecondOfDay method

Asserts that the current LocalTime does not have the specified nanosecond of day.

```csharp
public AndConstraint<LocalTimeAssertions> NotHaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current LocalTime is not expected to have. |
