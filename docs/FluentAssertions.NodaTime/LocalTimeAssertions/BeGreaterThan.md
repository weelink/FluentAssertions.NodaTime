# LocalTimeAssertions.BeGreaterThan method

Asserts that this LocalTime is greater than *other*.

```csharp
public AndConstraint<LocalTimeAssertions> BeGreaterThan(LocalTime other, string because = "", 
