# LocalTimeAssertions.NotHaveTicksWithinSecond method

Asserts that the current LocalTime does not have the specified tick of second.

```csharp
public AndConstraint<LocalTimeAssertions> NotHaveTicksWithinSecond(int tickOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfSecond | The tick of second that the current LocalTime is not expected to have. |
