# LocalTimeAssertions.BeLessThan method

Asserts that this LocalTime is less than *other*.

```csharp
public AndConstraint<LocalTimeAssertions> BeLessThan(LocalTime other, string because = "", 
