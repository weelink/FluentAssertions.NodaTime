# LocalTimeAssertions.NotHaveMillisecond method

Asserts that the current LocalTime does not have the specified millisecond.
...
| --- | --- |
| millisecond | The millisecond that the current LocalTime is not expected to have. |
