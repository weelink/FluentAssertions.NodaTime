# LocalTimeAssertions.HaveNanosecondOfSecond method

Asserts that the current LocalTime has the specified nanosecond of second.

```csharp
public AndConstraint<LocalTimeAssertions> HaveNanosecondOfSecond(int nanosecondOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfSecond | The nanosecond of second that the current LocalTime is expected to have. |
