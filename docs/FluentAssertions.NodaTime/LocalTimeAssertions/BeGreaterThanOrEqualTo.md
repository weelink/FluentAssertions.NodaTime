# LocalTimeAssertions.BeGreaterThanOrEqualTo method

Asserts that this LocalTime is on or after *other*.

```csharp
public AndConstraint<LocalTimeAssertions> BeGreaterThanOrEqualTo(LocalTime other, 
