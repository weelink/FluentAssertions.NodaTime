# LocalTimeAssertions.HaveHour method

Asserts that the current LocalTime has the specified hour of the day.

```csharp
public AndConstraint<LocalTimeAssertions> HaveHour(int hourOfDay, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hourOfDay | The hour of the day that the current LocalTime is expected to have. |
