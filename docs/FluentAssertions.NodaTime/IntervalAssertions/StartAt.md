# IntervalAssertions.StartAt method

Asserts that the current Interval starts at *instant*.

```csharp
public AndConstraint<IntervalAssertions> StartAt(Instant? instant, string because = "", 
