# IntervalAssertions.Contain method

Asserts that the current Interval contains *instant*.

```csharp
public AndConstraint<IntervalAssertions> Contain(Instant instant, string because = "", 
