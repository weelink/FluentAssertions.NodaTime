# IntervalAssertions.NotBe method

Asserts that this Interval is not equal to *other*.

```csharp
public AndConstraint<IntervalAssertions> NotBe(Interval? other, string because = "", 
