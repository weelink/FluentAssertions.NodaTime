# IntervalAssertions.NotEndAt method

Asserts that the current Interval does not end at *instant*.

```csharp
public AndConstraint<IntervalAssertions> NotEndAt(Instant? instant, string because = "", 
