# DurationAssertions.NotHaveMinutes method

Asserts that the current Duration does not have the specified minutes.

```csharp
public AndConstraint<DurationAssertions> NotHaveMinutes(int minutes, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| minutes | The minutes that the current Duration is not expected to have. |
