# DurationAssertions.HaveNanosecondsWithinDay method

Asserts that the current Duration has the specified nanoseconds within the day.

```csharp
public AndConstraint<DurationAssertions> HaveNanosecondsWithinDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanoseconds within the day that the current Duration is expected to have. |
