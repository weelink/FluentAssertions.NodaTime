# DurationAssertions.NotHaveMilliseconds method

Asserts that the current Duration does not have the specified milliseconds.
...
| --- | --- |
| milliseconds | The milliseconds that the current Duration is not expected to have. |
