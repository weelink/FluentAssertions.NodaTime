# DurationAssertions.HaveNanosecondOfDay method

Asserts that the current Duration has the specified nanosecond of day.

```csharp
public AndConstraint<DurationAssertions> HaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current Duration is expected to have. |
