# DurationAssertions.HaveTotalNanoseconds method (1 of 2)

Asserts that the current Duration has the specified total number of nanoseconds.

```csharp
public AndConstraint<DurationAssertions> HaveTotalNanoseconds(double totalNanoseconds, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| totalNanoseconds | The total number of nanoseconds that the current Duration is expected to have. |
...
# DurationAssertions.HaveTotalNanoseconds method (2 of 2)
