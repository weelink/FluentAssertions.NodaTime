# DurationAssertions.NotHaveSubsecondInTicks method

Asserts that the current Duration does not have the specified subseconds in ticks.
...
| --- | --- |
| ticks | The subseconds in ticks that the current Duration is not expected to have. |
