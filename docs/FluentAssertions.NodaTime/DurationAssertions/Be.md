# DurationAssertions.Be method (1 of 2)

Asserts that this Duration is equal to *other*.

```csharp
public AndConstraint<DurationAssertions> Be(Duration? other, string because = "", 
...
# DurationAssertions.Be method (2 of 2)

Asserts that this Duration is equal to *other*.

```csharp
public AndConstraint<DurationAssertions> Be(TimeSpan? other, string because = "", 
    params object[] becauseArgs)
```
