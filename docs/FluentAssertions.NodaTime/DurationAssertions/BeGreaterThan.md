# DurationAssertions.BeGreaterThan method

Asserts that this Duration is greater than *other*.

```csharp
public AndConstraint<DurationAssertions> BeGreaterThan(Duration other, string because = "", 
