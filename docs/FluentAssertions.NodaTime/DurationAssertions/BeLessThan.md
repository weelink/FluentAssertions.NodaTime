# DurationAssertions.BeLessThan method

Asserts that this Duration is less than *other*.

```csharp
public AndConstraint<DurationAssertions> BeLessThan(Duration other, string because = "", 
