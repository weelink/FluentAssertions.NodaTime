# DurationAssertions.HaveHours method

Asserts that the current Duration has the specified hours.

```csharp
public AndConstraint<DurationAssertions> HaveHours(int hours, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hours | The hours that the current Duration is expected to have. |
