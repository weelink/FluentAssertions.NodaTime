# DurationAssertions.HaveMilliseconds method

Asserts that the current Duration has the specified milliseconds.
...
| --- | --- |
| milliseconds | The milliseconds that the current Duration is expected to have. |
