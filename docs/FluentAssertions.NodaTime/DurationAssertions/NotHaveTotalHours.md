# DurationAssertions.NotHaveTotalHours method (1 of 2)

Asserts that the current Duration does not have the specified total number of hours.
...
| --- | --- |
| totalHours | The total number of hours that the current Duration is not expected to have. |
...
# DurationAssertions.NotHaveTotalHours method (2 of 2)

Asserts that the current Duration does not have the specified total number of hours.

```csharp
public AndConstraint<DurationAssertions> NotHaveTotalHours(double totalHours, double precision, 
