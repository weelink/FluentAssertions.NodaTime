# DurationAssertions.HaveTotalMinutes method (1 of 2)

Asserts that the current Duration has the specified total number of minutes.
...
| --- | --- |
| totalMinutes | The total number of minutes that the current Duration is expected to have. |
...
# DurationAssertions.HaveTotalMinutes method (2 of 2)

Asserts that the current Duration has the specified total number of minutes.

```csharp
public AndConstraint<DurationAssertions> HaveTotalMinutes(double totalMinutes, double precision, 
