# DurationAssertions.NotHaveTotalDays method (1 of 2)

Asserts that the current Duration does not have the specified total number of days.
...
| --- | --- |
| totalDays | The total number of days that the current Duration is not expected to have. |
...
# DurationAssertions.NotHaveTotalDays method (2 of 2)

Asserts that the current Duration does not have the specified total number of days.

```csharp
public AndConstraint<DurationAssertions> NotHaveTotalDays(double totalDays, double precision, 
