# DurationAssertions.HaveTotalMilliseconds method (1 of 2)

Asserts that the current Duration has the specified total number of milliseconds.

```csharp
public AndConstraint<DurationAssertions> HaveTotalMilliseconds(double totalMilliseconds, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| totalMilliseconds | The total number of milliseconds that the current Duration is expected to have. |
...
# DurationAssertions.HaveTotalMilliseconds method (2 of 2)
