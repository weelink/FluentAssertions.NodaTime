# DurationAssertions.NotHaveNanosecondOfDay method

Asserts that the current Duration does not have the specified nanosecond of day.

```csharp
public AndConstraint<DurationAssertions> NotHaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current Duration is not expected to have. |
