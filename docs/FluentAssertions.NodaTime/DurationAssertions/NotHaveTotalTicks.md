# DurationAssertions.NotHaveTotalTicks method (1 of 2)

Asserts that the current Duration does not have the specified total number of ticks.
...
| --- | --- |
| totalTicks | The total number of ticks that the current Duration is not expected to have. |
...
# DurationAssertions.NotHaveTotalTicks method (2 of 2)

Asserts that the current Duration does not have the specified total number of ticks.

```csharp
public AndConstraint<DurationAssertions> NotHaveTotalTicks(double totalTicks, double precision, 
