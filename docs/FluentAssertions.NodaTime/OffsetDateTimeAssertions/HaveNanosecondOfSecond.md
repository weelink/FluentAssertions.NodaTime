# OffsetDateTimeAssertions.HaveNanosecondOfSecond method

Asserts that the current OffsetDateTime has the specified nanosecond of second.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveNanosecondOfSecond(int nanosecondOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfSecond | The nanosecond of second that the current OffsetDateTime is expected to have. |
