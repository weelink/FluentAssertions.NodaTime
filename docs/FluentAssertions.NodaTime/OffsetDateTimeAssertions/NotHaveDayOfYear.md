# OffsetDateTimeAssertions.NotHaveDayOfYear method

Asserts that the current OffsetDateTime does not have the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current OffsetDateTime is not expected to have. |
