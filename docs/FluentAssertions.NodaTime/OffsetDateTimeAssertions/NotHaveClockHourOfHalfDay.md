# OffsetDateTimeAssertions.NotHaveClockHourOfHalfDay method

Asserts that the current OffsetDateTime does not have the specified hour of the half-day.

```csharp
public AndConstraint<OffsetDateTimeAssertions> NotHaveClockHourOfHalfDay(int clockHourOfHalfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| clockHourOfHalfDay | The hour of the half-day that the current OffsetDateTime is not expected to have. |
