# OffsetDateTimeAssertions.NotHaveNanosecondOfSecond method

Asserts that the current OffsetDateTime does not have the specified nanosecond of second.

```csharp
public AndConstraint<OffsetDateTimeAssertions> NotHaveNanosecondOfSecond(int nanosecondOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfSecond | The nanosecond of second that the current OffsetDateTime is not expected to have. |
