# OffsetDateTimeAssertions.HaveTicksWithinSecond method

Asserts that the current OffsetDateTime has the specified tick of second.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveTicksWithinSecond(int tickOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfSecond | The tick of second that the current OffsetDateTime is expected to have. |
