# OffsetDateTimeAssertions.HaveClockHourOfHalfDay method

Asserts that the current OffsetDateTime has the specified hour of the half-day.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveClockHourOfHalfDay(int clockHourOfHalfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| clockHourOfHalfDay | The hour of the half-day that the current OffsetDateTime is expected to have. |
