# OffsetDateTimeAssertions.HaveDayOfYear method

Asserts that the current OffsetDateTime has the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current OffsetDateTime is expected to have. |
