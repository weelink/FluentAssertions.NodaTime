# OffsetDateTimeAssertions.NotHaveTicksWithinDay method

Asserts that the current OffsetDateTime does not have the specified tick of day.

```csharp
public AndConstraint<OffsetDateTimeAssertions> NotHaveTicksWithinDay(long tickOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfDay | The tick of day that the current OffsetDateTime is not expected to have. |
