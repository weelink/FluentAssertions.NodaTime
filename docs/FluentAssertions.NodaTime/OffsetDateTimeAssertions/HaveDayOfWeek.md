# OffsetDateTimeAssertions.HaveDayOfWeek method

Asserts that the current OffsetDateTime has the specified day of the week.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current OffsetDateTime is expected to have. |
