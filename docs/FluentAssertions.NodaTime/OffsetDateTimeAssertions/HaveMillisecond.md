# OffsetDateTimeAssertions.HaveMillisecond method

Asserts that the current OffsetDateTime has the specified millisecond.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveMillisecond(int millisecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| millisecond | The millisecond that the current OffsetDateTime is expected to have. |
