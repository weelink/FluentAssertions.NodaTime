# OffsetDateTimeAssertions.NotHaveDay method

Asserts that the current OffsetDateTime does not have the specified day of the month.

```csharp
public AndConstraint<OffsetDateTimeAssertions> NotHaveDay(int day, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| day | The day of the month that the current OffsetDateTime is not expected to have. |
