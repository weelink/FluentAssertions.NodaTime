# OffsetDateTimeAssertions.NotHaveDate method

Asserts that the current OffsetDateTime does not have the specified OffsetDate.
...
| --- | --- |
| date | The LocalDate that the current OffsetDateTime is not expected to have. |
