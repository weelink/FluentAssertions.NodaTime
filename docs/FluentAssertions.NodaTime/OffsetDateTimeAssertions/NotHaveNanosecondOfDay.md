# OffsetDateTimeAssertions.NotHaveNanosecondOfDay method

Asserts that the current OffsetDateTime does not have the specified nanosecond of day.

```csharp
public AndConstraint<OffsetDateTimeAssertions> NotHaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current OffsetDateTime is not expected to have. |
