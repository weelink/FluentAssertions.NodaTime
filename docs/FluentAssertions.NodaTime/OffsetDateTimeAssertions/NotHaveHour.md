# OffsetDateTimeAssertions.NotHaveHour method

Asserts that the current OffsetDateTime does not have the specified hour of the day.
...
| --- | --- |
| hourOfDay | The hour of the day that the current OffsetDateTime is not expected to have. |
