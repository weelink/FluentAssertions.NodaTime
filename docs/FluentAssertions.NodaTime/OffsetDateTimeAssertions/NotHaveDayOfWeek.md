# OffsetDateTimeAssertions.NotHaveDayOfWeek method

Asserts that the current OffsetDateTime does not have the specified day of the week.

```csharp
public AndConstraint<OffsetDateTimeAssertions> NotHaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current OffsetDateTime is not expected to have. |
