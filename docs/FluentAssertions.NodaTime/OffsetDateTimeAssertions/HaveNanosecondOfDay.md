# OffsetDateTimeAssertions.HaveNanosecondOfDay method

Asserts that the current OffsetDateTime has the specified nanosecond of day.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current OffsetDateTime is expected to have. |
