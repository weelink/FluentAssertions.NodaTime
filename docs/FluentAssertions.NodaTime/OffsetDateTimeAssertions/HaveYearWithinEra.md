# OffsetDateTimeAssertions.HaveYearWithinEra method

Asserts that the current OffsetDateTime has the specified year of era.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveYearWithinEra(int yearOfEra, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| yearOfEra | The year of era that the current OffsetDateTime is expected to have. |
