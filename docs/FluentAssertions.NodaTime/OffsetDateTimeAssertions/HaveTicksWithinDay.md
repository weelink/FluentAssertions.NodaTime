# OffsetDateTimeAssertions.HaveTicksWithinDay method

Asserts that the current OffsetDateTime has the specified tick of day.

```csharp
public AndConstraint<OffsetDateTimeAssertions> HaveTicksWithinDay(long tickOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfDay | The tick of day that the current OffsetDateTime is expected to have. |
