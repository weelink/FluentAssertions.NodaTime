# DateIntervalAssertions.NotEndAt method

Asserts that the current DateInterval does not end at *localDate*.

```csharp
public AndConstraint<DateIntervalAssertions> NotEndAt(LocalDate? localDate, string because = "", 
