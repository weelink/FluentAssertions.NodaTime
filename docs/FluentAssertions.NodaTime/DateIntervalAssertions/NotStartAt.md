# DateIntervalAssertions.NotStartAt method

Asserts that the current DateInterval does not start at *localDate*.

```csharp
public AndConstraint<DateIntervalAssertions> NotStartAt(LocalDate? localDate, string because = "", 
