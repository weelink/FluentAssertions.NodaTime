# DateIntervalAssertions.NotBeInDays method

Asserts that the length of this DateInterval is not equal to *days* days.

```csharp
public AndConstraint<DateIntervalAssertions> NotBeInDays(int days, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| days | The length of this date interval in days.. |
