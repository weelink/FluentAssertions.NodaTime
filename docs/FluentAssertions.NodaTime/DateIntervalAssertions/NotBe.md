# DateIntervalAssertions.NotBe method

Asserts that this DateInterval is not equal to *other*.

```csharp
public AndConstraint<DateIntervalAssertions> NotBe(DateInterval? other, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| other | The DateInterval to compare to. |
