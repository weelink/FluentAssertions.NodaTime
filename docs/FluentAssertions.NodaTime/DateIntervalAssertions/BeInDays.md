# DateIntervalAssertions.BeInDays method

Asserts that the length of this DateInterval is equal to *days* days.

```csharp
public AndConstraint<DateIntervalAssertions> BeInDays(int days, string because = "", 
