# DateIntervalAssertions.Be method

Asserts that this DateInterval is equal to *other*.

```csharp
public AndConstraint<DateIntervalAssertions> Be(DateInterval? other, string because = "", 
