# InstantAssertions.NotBeCloseTo method (1 of 2)

Asserts that this Instant is not within *precision* of *other*.

```csharp
public AndConstraint<InstantAssertions> NotBeCloseTo(Instant other, Duration precision, 
...
# InstantAssertions.NotBeCloseTo method (2 of 2)

Asserts that this Instant is not within *precision* of *other*.

```csharp
public AndConstraint<InstantAssertions> NotBeCloseTo(Instant other, TimeSpan precision, 
    string because = "", params object[] becauseArgs)
```
