# OffsetTimeAssertions.Be method

Asserts that this OffsetTime is equal to *other*.

```csharp
public AndConstraint<OffsetTimeAssertions> Be(OffsetTime? other, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| other | The OffsetTime to compare to. |
