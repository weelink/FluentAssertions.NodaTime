# OffsetTimeAssertions.HaveMillisecond method

Asserts that the current OffsetTime has the specified millisecond.
...
| --- | --- |
| millisecond | The millisecond that the current OffsetTime is expected to have. |
