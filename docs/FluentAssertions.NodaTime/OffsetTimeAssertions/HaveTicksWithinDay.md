# OffsetTimeAssertions.HaveTicksWithinDay method

Asserts that the current OffsetTime has the specified tick of day.
...
| --- | --- |
| tickOfDay | The tick of day that the current OffsetTime is expected to have. |
