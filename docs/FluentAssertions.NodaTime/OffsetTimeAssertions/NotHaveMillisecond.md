# OffsetTimeAssertions.NotHaveMillisecond method

Asserts that the current OffsetTime does not have the specified millisecond.
...
| --- | --- |
| millisecond | The millisecond that the current OffsetTime is not expected to have. |
