# OffsetDateAssertions.HaveEra method

Asserts that the current OffsetDate has the specified era.

```csharp
public AndConstraint<OffsetDateAssertions> HaveEra(Era era, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| era | The era that the current OffsetDate is expected to have. |
