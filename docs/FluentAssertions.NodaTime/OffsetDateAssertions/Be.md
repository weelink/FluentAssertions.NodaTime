# OffsetDateAssertions.Be method

Asserts that this OffsetDate is equal to *other*.

```csharp
public AndConstraint<OffsetDateAssertions> Be(OffsetDate? other, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| other | The OffsetDate to compare to. |
