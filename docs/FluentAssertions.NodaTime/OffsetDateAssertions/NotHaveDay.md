# OffsetDateAssertions.NotHaveDay method

Asserts that the current OffsetDate does not have the specified day of the month.

```csharp
public AndConstraint<OffsetDateAssertions> NotHaveDay(int day, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| day | The day of the month that the current OffsetDate is not expected to have. |
