# OffsetDateAssertions.NotHaveDayOfWeek method

Asserts that the current OffsetDate does not have the specified day of the week.

```csharp
public AndConstraint<OffsetDateAssertions> NotHaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current OffsetDate is not expected to have. |
