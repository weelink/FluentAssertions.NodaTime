# OffsetDateAssertions.NotHaveYearWithinEra method

Asserts that the current OffsetDate does not have the specified year of era.
...
| --- | --- |
| yearOfEra | The year of era that the current OffsetDate is not expected to have. |
