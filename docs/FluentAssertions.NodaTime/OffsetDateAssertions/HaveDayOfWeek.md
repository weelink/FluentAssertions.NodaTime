# OffsetDateAssertions.HaveDayOfWeek method

Asserts that the current OffsetDate has the specified day of the week.

```csharp
public AndConstraint<OffsetDateAssertions> HaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current OffsetDate is expected to have. |
