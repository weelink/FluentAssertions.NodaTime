# OffsetDateAssertions.HaveDay method

Asserts that the current OffsetDate has the specified day of the month.

```csharp
public AndConstraint<OffsetDateAssertions> HaveDay(int day, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| day | The day of the month that the current OffsetDate is expected to have. |
