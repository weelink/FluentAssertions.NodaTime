# OffsetDateAssertions.NotHaveDayOfYear method

Asserts that the current OffsetDate does not have the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current OffsetDate is not expected to have. |
