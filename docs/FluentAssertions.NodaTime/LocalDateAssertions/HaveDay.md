# LocalDateAssertions.HaveDay method

Asserts that the current LocalDate has the specified day of the month.

```csharp
public AndConstraint<LocalDateAssertions> HaveDay(int day, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| day | The day of the month that the current LocalDate is expected to have. |
