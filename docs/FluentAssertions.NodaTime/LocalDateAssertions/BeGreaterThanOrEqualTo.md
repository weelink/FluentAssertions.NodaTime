# LocalDateAssertions.BeGreaterThanOrEqualTo method

Asserts that this LocalDate is on or after *other*.

```csharp
public AndConstraint<LocalDateAssertions> BeGreaterThanOrEqualTo(LocalDate other, 
