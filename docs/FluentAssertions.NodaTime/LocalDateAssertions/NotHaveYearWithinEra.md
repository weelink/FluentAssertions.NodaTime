# LocalDateAssertions.NotHaveYearWithinEra method

Asserts that the current LocalDate does not have the specified year of era.
...
| --- | --- |
| yearOfEra | The year of era that the current LocalDate is not expected to have. |
