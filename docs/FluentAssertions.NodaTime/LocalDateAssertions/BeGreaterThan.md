# LocalDateAssertions.BeGreaterThan method

Asserts that this LocalDate is greater than *other*.

```csharp
public AndConstraint<LocalDateAssertions> BeGreaterThan(LocalDate other, string because = "", 
