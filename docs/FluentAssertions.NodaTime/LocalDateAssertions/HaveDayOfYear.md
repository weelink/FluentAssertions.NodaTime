# LocalDateAssertions.HaveDayOfYear method

Asserts that the current LocalDate has the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current LocalDate is expected to have. |
