# LocalDateAssertions.HaveEra method

Asserts that the current LocalDate has the specified era.

```csharp
public AndConstraint<LocalDateAssertions> HaveEra(Era era, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| era | The era that the current LocalDate is expected to have. |
