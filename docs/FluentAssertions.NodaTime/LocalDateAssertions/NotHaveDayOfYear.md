# LocalDateAssertions.NotHaveDayOfYear method

Asserts that the current LocalDate does not have the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current LocalDate is not expected to have. |
