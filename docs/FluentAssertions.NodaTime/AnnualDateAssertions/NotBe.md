# AnnualDateAssertions.NotBe method

Asserts that this AnnualDate is not equal to *other*.

```csharp
public AndConstraint<AnnualDateAssertions> NotBe(AnnualDate? other, string because = "", 
