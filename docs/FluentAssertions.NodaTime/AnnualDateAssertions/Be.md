# AnnualDateAssertions.Be method

Asserts that this AnnualDate is equal to *other*.

```csharp
public AndConstraint<AnnualDateAssertions> Be(AnnualDate? other, string because = "", 
