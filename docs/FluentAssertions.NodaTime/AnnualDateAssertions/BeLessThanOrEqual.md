# AnnualDateAssertions.BeLessThanOrEqual method

Asserts that this AnnualDate is less than or equal to *other*.

```csharp
public AndConstraint<AnnualDateAssertions> BeLessThanOrEqual(AnnualDate other, string because = "", 
