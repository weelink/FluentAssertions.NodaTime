# ZonedDateTimeAssertions.NotHaveMillisecond method

Asserts that the current ZonedDateTime does not have the specified millisecond.

```csharp
public AndConstraint<ZonedDateTimeAssertions> NotHaveMillisecond(int millisecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| millisecond | The millisecond that the current ZonedDateTime is not expected to have. |
