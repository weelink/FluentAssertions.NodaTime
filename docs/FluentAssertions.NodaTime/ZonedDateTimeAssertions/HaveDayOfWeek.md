# ZonedDateTimeAssertions.HaveDayOfWeek method

Asserts that the current ZonedDateTime has the specified day of the week.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current ZonedDateTime is expected to have. |
