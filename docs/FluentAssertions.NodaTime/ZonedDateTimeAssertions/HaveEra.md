# ZonedDateTimeAssertions.HaveEra method

Asserts that the current ZonedDateTime has the specified era.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveEra(Era era, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| era | The era that the current ZonedDateTime is expected to have. |
