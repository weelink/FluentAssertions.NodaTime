# ZonedDateTimeAssertions.NotHaveTicksWithinDay method

Asserts that the current ZonedDateTime does not have the specified tick of day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> NotHaveTicksWithinDay(long tickOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfDay | The tick of day that the current ZonedDateTime is not expected to have. |
