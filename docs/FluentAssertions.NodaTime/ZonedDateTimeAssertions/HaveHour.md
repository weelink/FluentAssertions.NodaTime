# ZonedDateTimeAssertions.HaveHour method

Asserts that the current ZonedDateTime has the specified hour of the day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveHour(int hourOfDay, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hourOfDay | The hour of the day that the current ZonedDateTime is expected to have. |
