# ZonedDateTimeAssertions.HaveMillisecond method

Asserts that the current ZonedDateTime has the specified millisecond.
...
| --- | --- |
| millisecond | The millisecond that the current ZonedDateTime is expected to have. |
