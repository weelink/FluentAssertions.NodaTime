# ZonedDateTimeAssertions.HaveDay method

Asserts that the current ZonedDateTime has the specified day of the month.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveDay(int day, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| day | The day of the month that the current ZonedDateTime is expected to have. |
