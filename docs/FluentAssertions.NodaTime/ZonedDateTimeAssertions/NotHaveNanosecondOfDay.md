# ZonedDateTimeAssertions.NotHaveNanosecondOfDay method

Asserts that the current ZonedDateTime does not have the specified nanosecond of day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> NotHaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current ZonedDateTime is not expected to have. |
