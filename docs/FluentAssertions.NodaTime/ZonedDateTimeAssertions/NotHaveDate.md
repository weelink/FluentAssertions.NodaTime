# ZonedDateTimeAssertions.NotHaveDate method

Asserts that the current ZonedDateTime does not have the specified LocalDate.
...
| --- | --- |
| date | The LocalDate that the current ZonedDateTime is not expected to have. |
