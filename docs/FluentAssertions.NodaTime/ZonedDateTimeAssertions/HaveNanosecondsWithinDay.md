# ZonedDateTimeAssertions.HaveNanosecondsWithinDay method

Asserts that the current ZonedDateTime has the specified nanoseconds within the day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveNanosecondsWithinDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanoseconds within the day that the current ZonedDateTime is expected to have. |
