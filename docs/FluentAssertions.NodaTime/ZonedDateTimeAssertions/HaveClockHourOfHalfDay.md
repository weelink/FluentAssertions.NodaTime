# ZonedDateTimeAssertions.HaveClockHourOfHalfDay method

Asserts that the current ZonedDateTime has the specified hour of the half-day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveClockHourOfHalfDay(int clockHourOfHalfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| clockHourOfHalfDay | The hour of the half-day that the current ZonedDateTime is expected to have. |
