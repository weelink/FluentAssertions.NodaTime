# ZonedDateTimeAssertions.NotHaveHour method

Asserts that the current ZonedDateTime does not have the specified hour of the day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> NotHaveHour(int hourOfDay, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hourOfDay | The hour of the day that the current ZonedDateTime is not expected to have. |
