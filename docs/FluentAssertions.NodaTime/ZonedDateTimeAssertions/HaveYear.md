# ZonedDateTimeAssertions.HaveYear method

Asserts that the current ZonedDateTime has the specified year.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveYear(int year, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| year | The year that the current ZonedDateTime is expected to have. |
