# ZonedDateTimeAssertions.HaveNanosecondOfDay method

Asserts that the current ZonedDateTime has the specified nanosecond of day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current ZonedDateTime is expected to have. |
