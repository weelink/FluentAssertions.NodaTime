# ZonedDateTimeAssertions.HaveSecond method

Asserts that the current ZonedDateTime has the specified second.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveSecond(int second, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| second | The second that the current ZonedDateTime is expected to have. |
