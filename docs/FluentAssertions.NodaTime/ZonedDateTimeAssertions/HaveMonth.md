# ZonedDateTimeAssertions.HaveMonth method

Asserts that the current ZonedDateTime has the specified month.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveMonth(int month, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| month | The month that the current ZonedDateTime is expected to have. |
