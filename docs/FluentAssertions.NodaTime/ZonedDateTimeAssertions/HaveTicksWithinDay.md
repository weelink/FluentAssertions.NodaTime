# ZonedDateTimeAssertions.HaveTicksWithinDay method

Asserts that the current ZonedDateTime has the specified tick of day.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveTicksWithinDay(long tickOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfDay | The tick of day that the current ZonedDateTime is expected to have. |
