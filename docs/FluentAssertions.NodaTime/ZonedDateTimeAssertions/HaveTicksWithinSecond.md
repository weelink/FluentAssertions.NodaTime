# ZonedDateTimeAssertions.HaveTicksWithinSecond method

Asserts that the current ZonedDateTime has the specified tick of second.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveTicksWithinSecond(int tickOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfSecond | The tick of second that the current ZonedDateTime is expected to have. |
