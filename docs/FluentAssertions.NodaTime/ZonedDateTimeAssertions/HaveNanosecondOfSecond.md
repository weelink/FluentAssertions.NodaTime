# ZonedDateTimeAssertions.HaveNanosecondOfSecond method

Asserts that the current ZonedDateTime has the specified nanosecond of second.

```csharp
public AndConstraint<ZonedDateTimeAssertions> HaveNanosecondOfSecond(int nanosecondOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfSecond | The nanosecond of second that the current ZonedDateTime is expected to have. |
