# ZonedDateTimeAssertions.NotHaveNanosecondOfSecond method

Asserts that the current ZonedDateTime does not have the specified nanosecond of second.

```csharp
public AndConstraint<ZonedDateTimeAssertions> NotHaveNanosecondOfSecond(int nanosecondOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfSecond | The nanosecond of second that the current ZonedDateTime is not expected to have. |
