# ZonedDateTimeAssertions.NotHaveTicksWithinSecond method

Asserts that the current ZonedDateTime does not have the specified tick of second.

```csharp
public AndConstraint<ZonedDateTimeAssertions> NotHaveTicksWithinSecond(int tickOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfSecond | The tick of second that the current ZonedDateTime is not expected to have. |
