# ZonedDateTimeAssertions.NotHaveDayOfYear method

Asserts that the current ZonedDateTime does not have the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current ZonedDateTime is not expected to have. |
