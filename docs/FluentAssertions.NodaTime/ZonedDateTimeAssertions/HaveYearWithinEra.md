# ZonedDateTimeAssertions.HaveYearWithinEra method

Asserts that the current ZonedDateTime has the specified year of era.
...
| --- | --- |
| yearOfEra | The year of era that the current ZonedDateTime is expected to have. |
