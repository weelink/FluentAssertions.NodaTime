# OffsetAssertions.HaveMilliseconds method

Asserts that the current Offset has the specified milliseconds.
...
| --- | --- |
| milliseconds | The milliseconds that the current Offset is expected to have. |
