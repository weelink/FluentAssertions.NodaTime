# OffsetAssertions.BeGreaterThan method

Asserts that this Offset is greater than *other*.

```csharp
public AndConstraint<OffsetAssertions> BeGreaterThan(Offset other, string because = "", 
