# OffsetAssertions.NotHaveNanoseconds method

Asserts that the current Offset does not have the specified nanoseconds.
...
| --- | --- |
| nanoseconds | The nanoseconds that the current Offset is not expected to have. |
