# OffsetAssertions.BeLessThan method

Asserts that this Offset is less than *other*.

```csharp
public AndConstraint<OffsetAssertions> BeLessThan(Offset other, string because = "", 
