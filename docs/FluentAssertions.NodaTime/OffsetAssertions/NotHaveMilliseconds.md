# OffsetAssertions.NotHaveMilliseconds method

Asserts that the current Offset does not have the specified milliseconds.
...
| --- | --- |
| milliseconds | The milliseconds that the current Offset is not expected to have. |
