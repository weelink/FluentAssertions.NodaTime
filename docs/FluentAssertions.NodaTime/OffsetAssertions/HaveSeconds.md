# OffsetAssertions.HaveSeconds method

Asserts that the current Offset has the specified seconds.

```csharp
public AndConstraint<OffsetAssertions> HaveSeconds(int seconds, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| seconds | The seconds that the current Offset is expected to have. |
