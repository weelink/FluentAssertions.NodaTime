# LocalDateTimeAssertions.NotHaveHour method

Asserts that the current LocalDateTime does not have the specified hour of the day.

```csharp
public AndConstraint<LocalDateTimeAssertions> NotHaveHour(int hourOfDay, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hourOfDay | The hour of the day that the current LocalDateTime is not expected to have. |
