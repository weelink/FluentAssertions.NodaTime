# LocalDateTimeAssertions.BeLessThanOrEqualTo method

Asserts that this LocalDateTime is less than or equal to *other*.

```csharp
public AndConstraint<LocalDateTimeAssertions> BeLessThanOrEqualTo(LocalDateTime other, 
