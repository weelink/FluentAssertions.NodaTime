# LocalDateTimeAssertions.BeGreaterThanOrEqualTo method

Asserts that this LocalDateTime is on or after *other*.

```csharp
public AndConstraint<LocalDateTimeAssertions> BeGreaterThanOrEqualTo(LocalDateTime other, 
