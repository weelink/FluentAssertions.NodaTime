# LocalDateTimeAssertions.HaveNanosecondsWithinDay method

Asserts that the current LocalDateTime has the specified nanoseconds within the day.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveNanosecondsWithinDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanoseconds within the day that the current LocalDateTime is expected to have. |
