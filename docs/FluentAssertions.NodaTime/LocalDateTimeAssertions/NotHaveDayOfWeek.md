# LocalDateTimeAssertions.NotHaveDayOfWeek method

Asserts that the current LocalDateTime does not have the specified day of the week.

```csharp
public AndConstraint<LocalDateTimeAssertions> NotHaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current LocalDateTime is not expected to have. |
