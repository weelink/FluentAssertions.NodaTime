# LocalDateTimeAssertions.NotHaveClockHourOfHalfDay method

Asserts that the current LocalDateTime does not have the specified hour of the half-day.

```csharp
public AndConstraint<LocalDateTimeAssertions> NotHaveClockHourOfHalfDay(int clockHourOfHalfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| clockHourOfHalfDay | The hour of the half-day that the current LocalDateTime is not expected to have. |
