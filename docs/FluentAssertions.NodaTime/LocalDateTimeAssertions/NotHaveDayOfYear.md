# LocalDateTimeAssertions.NotHaveDayOfYear method

Asserts that the current LocalDateTime does not have the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current LocalDateTime is not expected to have. |
