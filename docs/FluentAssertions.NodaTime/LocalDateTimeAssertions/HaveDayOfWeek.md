# LocalDateTimeAssertions.HaveDayOfWeek method

Asserts that the current LocalDateTime has the specified day of the week.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveDayOfWeek(IsoDayOfWeek dayOfWeek, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| dayOfWeek | The day of the week that the current LocalDateTime is expected to have. |
