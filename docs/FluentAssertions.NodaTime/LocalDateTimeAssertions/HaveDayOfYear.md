# LocalDateTimeAssertions.HaveDayOfYear method

Asserts that the current LocalDateTime has the specified day of the year.
...
| --- | --- |
| dayOfYear | The day of the year that the current LocalDateTime is expected to have. |
