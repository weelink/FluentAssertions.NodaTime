# LocalDateTimeAssertions.HaveHour method

Asserts that the current LocalDateTime has the specified hour of the day.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveHour(int hourOfDay, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hourOfDay | The hour of the day that the current LocalDateTime is expected to have. |
