# LocalDateTimeAssertions.HaveClockHourOfHalfDay method

Asserts that the current LocalDateTime has the specified hour of the half-day.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveClockHourOfHalfDay(int clockHourOfHalfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| clockHourOfHalfDay | The hour of the half-day that the current LocalDateTime is expected to have. |
