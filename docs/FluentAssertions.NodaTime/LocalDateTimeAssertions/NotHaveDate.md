# LocalDateTimeAssertions.NotHaveDate method

Asserts that the current LocalDateTime does not have the specified LocalDate.
...
| --- | --- |
| date | The LocalDate that the current LocalDateTime is not expected to have. |
