# LocalDateTimeAssertions.HaveNanosecondOfDay method

Asserts that the current LocalDateTime has the specified nanosecond of day.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveNanosecondOfDay(long nanosecondOfDay, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfDay | The nanosecond of day that the current LocalDateTime is expected to have. |
