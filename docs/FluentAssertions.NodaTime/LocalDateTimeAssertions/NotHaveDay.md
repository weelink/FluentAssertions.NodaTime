# LocalDateTimeAssertions.NotHaveDay method

Asserts that the current LocalDateTime does not have the specified day of the month.

```csharp
public AndConstraint<LocalDateTimeAssertions> NotHaveDay(int day, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| day | The day of the month that the current LocalDateTime is not expected to have. |
