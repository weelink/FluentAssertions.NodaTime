# LocalDateTimeAssertions.HaveMillisecond method

Asserts that the current LocalDateTime has the specified millisecond.
...
| --- | --- |
| millisecond | The millisecond that the current LocalDateTime is expected to have. |
