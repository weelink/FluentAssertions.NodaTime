# LocalDateTimeAssertions.NotBe method (1 of 3)

Asserts that this LocalDateTime is not equal to *dateTime*.

```csharp
public AndConstraint<LocalDateTimeAssertions> NotBe(DateTime? dateTime, string because = "", 
...
# LocalDateTimeAssertions.NotBe method (2 of 3)

Asserts that this LocalDateTime is not equal to *other*.
...
# LocalDateTimeAssertions.NotBe method (3 of 3)

Asserts that this LocalDateTime is not equal to *dateTime* in *calendar*.

```csharp
public AndConstraint<LocalDateTimeAssertions> NotBe(DateTime? dateTime, CalendarSystem calendar, 
