# LocalDateTimeAssertions.HaveNanosecondOfSecond method

Asserts that the current LocalDateTime has the specified nanosecond of second.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveNanosecondOfSecond(int nanosecondOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanosecondOfSecond | The nanosecond of second that the current LocalDateTime is expected to have. |
