# LocalDateTimeAssertions.HaveTicksWithinSecond method

Asserts that the current LocalDateTime has the specified tick of second.

```csharp
public AndConstraint<LocalDateTimeAssertions> HaveTicksWithinSecond(int tickOfSecond, 
    string because = "", params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| tickOfSecond | The tick of second that the current LocalDateTime is expected to have. |
