# LocalDateTimeAssertions.BeGreaterThan method

Asserts that this LocalDateTime is greater than *other*.

```csharp
public AndConstraint<LocalDateTimeAssertions> BeGreaterThan(LocalDateTime other, 
