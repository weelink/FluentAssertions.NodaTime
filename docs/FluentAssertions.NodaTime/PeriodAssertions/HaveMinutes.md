# PeriodAssertions.HaveMinutes method

Asserts that the current Period has the specified minutes.

```csharp
public AndConstraint<PeriodAssertions> HaveMinutes(long minutes, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| minutes | The minutes that the current Period is expected to have. |
