# PeriodAssertions.NotHaveDateComponent method

Asserts that the current Period does not have any non-zero date-based properties (days or higher).

```csharp
public AndConstraint<PeriodAssertions> NotHaveDateComponent(string because = "", 
