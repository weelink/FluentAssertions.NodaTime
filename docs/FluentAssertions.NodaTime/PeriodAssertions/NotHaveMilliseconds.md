# PeriodAssertions.NotHaveMilliseconds method

Asserts that the current Period does not have the specified milliseconds.
...
| --- | --- |
| milliseconds | The milliseconds that the current Period is not expected to have. |
