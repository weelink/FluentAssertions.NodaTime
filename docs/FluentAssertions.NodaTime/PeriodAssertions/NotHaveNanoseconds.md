# PeriodAssertions.NotHaveNanoseconds method

Asserts that the current Period does not have the specified nanoseconds.
...
| --- | --- |
| nanoseconds | The nanoseconds that the current Period is not expected to have. |
