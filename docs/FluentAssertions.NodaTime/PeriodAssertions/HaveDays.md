# PeriodAssertions.HaveDays method

Asserts that the current Period has the specified days.

```csharp
public AndConstraint<PeriodAssertions> HaveDays(int days, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| days | The days that the current Period is expected to have. |
