# PeriodAssertions.HaveSeconds method

Asserts that the current Period has the specified seconds.

```csharp
public AndConstraint<PeriodAssertions> HaveSeconds(long seconds, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| seconds | The seconds that the current Period is expected to have. |
