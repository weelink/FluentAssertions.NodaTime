# PeriodAssertions.NotHaveMinutes method

Asserts that the current Period does not have the specified minutes.

```csharp
public AndConstraint<PeriodAssertions> NotHaveMinutes(long minutes, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| minutes | The minutes that the current Period is not expected to have. |
