# PeriodAssertions.NotHaveTimeComponent method

Asserts that the current Period does not have any non-zero time-based properties (hours or lower).

```csharp
public AndConstraint<PeriodAssertions> NotHaveTimeComponent(string because = "", 
