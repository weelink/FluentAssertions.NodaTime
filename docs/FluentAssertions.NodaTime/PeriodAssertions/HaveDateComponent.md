# PeriodAssertions.HaveDateComponent method

Asserts that the current Period has any non-zero date-based properties (days or higher).

```csharp
public AndConstraint<PeriodAssertions> HaveDateComponent(string because = "", 
