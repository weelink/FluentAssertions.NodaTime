# PeriodAssertions.NotHaveWeeks method

Asserts that the current Period does not have the specified weeks.

```csharp
public AndConstraint<PeriodAssertions> NotHaveWeeks(int weeks, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| weeks | The weeks that the current Period is not expected to have. |
