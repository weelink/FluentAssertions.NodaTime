# PeriodAssertions.NotHaveMonths method

Asserts that the current Period does not have the specified months.

```csharp
public AndConstraint<PeriodAssertions> NotHaveMonths(int months, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| months | The months that the current Period is not expected to have. |
