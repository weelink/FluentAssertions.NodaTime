# PeriodAssertions.Be method (1 of 2)

Asserts that this Period is equal to *other*.

```csharp
public AndConstraint<PeriodAssertions> Be(Duration? other, string because = "", 
...
# PeriodAssertions.Be method (2 of 2)

Asserts that this Period is equal to *other*.

```csharp
public AndConstraint<PeriodAssertions> Be(Period? other, string because = "", 
    params object[] becauseArgs)
```
