# PeriodAssertions.NotHaveDays method

Asserts that the current Period does not have the specified days.

```csharp
public AndConstraint<PeriodAssertions> NotHaveDays(int days, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| days | The days that the current Period is not expected to have. |
