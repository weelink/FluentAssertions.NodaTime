# PeriodAssertions.NotHaveHours method

Asserts that the current Period does not have the specified hours.

```csharp
public AndConstraint<PeriodAssertions> NotHaveHours(long hours, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hours | The hours that the current Period is not expected to have. |
