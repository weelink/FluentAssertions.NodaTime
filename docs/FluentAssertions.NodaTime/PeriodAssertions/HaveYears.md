# PeriodAssertions.HaveYears method

Asserts that the current Period has the specified years.

```csharp
public AndConstraint<PeriodAssertions> HaveYears(int years, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| years | The years that the current Period is expected to have. |
