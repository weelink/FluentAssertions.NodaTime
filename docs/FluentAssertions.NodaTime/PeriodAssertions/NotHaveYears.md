# PeriodAssertions.NotHaveYears method

Asserts that the current Period does not have the specified years.

```csharp
public AndConstraint<PeriodAssertions> NotHaveYears(int years, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| years | The years that the current Period is not expected to have. |
