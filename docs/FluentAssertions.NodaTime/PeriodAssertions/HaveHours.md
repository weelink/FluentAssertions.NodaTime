# PeriodAssertions.HaveHours method

Asserts that the current Period has the specified hours.

```csharp
public AndConstraint<PeriodAssertions> HaveHours(long hours, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| hours | The hours that the current Period is expected to have. |
