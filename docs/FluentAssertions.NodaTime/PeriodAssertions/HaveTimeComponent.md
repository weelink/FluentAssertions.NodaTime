# PeriodAssertions.HaveTimeComponent method

Asserts that the current Period has any non-zero time-based properties (hours or lower).

```csharp
public AndConstraint<PeriodAssertions> HaveTimeComponent(string because = "", 
