# PeriodAssertions.HaveNanoseconds method

Asserts that the current Period has the specified nanoseconds.

```csharp
public AndConstraint<PeriodAssertions> HaveNanoseconds(long nanoseconds, string because = "", 
    params object[] becauseArgs)
```

| parameter | description |
| --- | --- |
| nanoseconds | The nanoseconds that the current Period is expected to have. |
